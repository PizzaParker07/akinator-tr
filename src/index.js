 ...
 * @prop {string} [options.language="tr"] The language of the game. Defaults to `tr`.
...
module.exports = async function (input, options) {
    ...
    try {
        ...
        options.language = options.language || "tr";
        ...
        if (!fs.existsSync(`${__dirname}/translations/${options.language}.json`)) return console.log(`Discord.js Akinator Error: Language "${options.language}" cannot be found. Examples: "tr", "fr", "es", etc.\nNeed help? Join our Discord server at 'https://discord.gg/P2g24jp'`);
        ...
        //starts the game
        let gameTypeRegion = options.gameType == "animal" ? "en_animals" : options.gameType == "character" ? "tr" : "en_objects";
